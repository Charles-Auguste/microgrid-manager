...
if __name__ == '__main__':
	...
	parser.add_argument('-s', '--scenario', type=str, required=True, help='path to scenario file (prices.csv)')
	...
	manager = Manager(args.team, args.players, args.scenario)
	manager.simulate(args.runs, name)
